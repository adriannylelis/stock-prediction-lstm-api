...
PROD_CONFIG_PATH = Path(__file__).parent.parent.parent.parent / 'configs' / 'production_model.yaml'
PREP_CONFIG_PATH = Path(__file__).parent.parent.parent.parent / 'artifacts' / 'models' / 'scalers' / 'preprocessing_config.json'
CHECKPOINT_PATH = Path(__file__).parent.parent.parent.parent / 'artifacts' / 'models' / 'best_model.pt'
...
def get_model_info():
    ...
    try:
        ...
        if CHECKPOINT_PATH.exists():
            ...
            response["num_features"] = ckpt.get("num_features", response.get("num_features"))
            response["num_tickers"] = ckpt.get("num_tickers", response.get("num_tickers"))
